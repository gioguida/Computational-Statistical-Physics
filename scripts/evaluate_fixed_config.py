...
def build_fixed_params(
    ...
    return {
        ...
        "interaction_curvature_bonus": float(inter_cfg.get("curvature_bonus", 0.0)),
        "interaction_curvature_penalty": float(inter_cfg.get("curvature_penalty", 0.0)),
        "interaction_curvature_tolerance": float(inter_cfg.get("curvature_tolerance", 0.1)),
        ...
        "chain_bonus": float(ann_cfg.get("chain_bonus", 0.0)),
        "radial_penalty": float(ann_cfg.get("radial_penalty", 0.0)),
        "radial_tolerance": float(ann_cfg.get("radial_tolerance", 0.3)),
        ...
        "annealing_curvature_bonus": float(ann_cfg.get("curvature_bonus", 0.0)),
        "annealing_curvature_penalty": float(ann_cfg.get("curvature_penalty", 0.0)),
        "annealing_curvature_tolerance": float(ann_cfg.get("curvature_tolerance", 0.08)),
        ...
        try:
            ...
            run_cmd(
                [
                    ...
                    "--curvature-bonus",
                    str(fixed_params["interaction_curvature_bonus"]),
                    "--curvature-penalty",
                    str(fixed_params["interaction_curvature_penalty"]),
                    "--curvature-tolerance",
                    str(fixed_params["interaction_curvature_tolerance"]),
                ],
                cwd=PROJECT_ROOT,
            ...
            run_cmd(
                [
                    ...
                    str(fixed_params["layer01_radial_penalty"]),
                    "--layer01-radial-tolerance",
                    str(fixed_params["layer01_radial_tolerance"]),
                    "--chain-bonus",
                    str(fixed_params["chain_bonus"]),
                    "--radial-penalty",
                    str(fixed_params["radial_penalty"]),
                    "--radial-tolerance",
                    str(fixed_params["radial_tolerance"]),
                    "--first-gap",
                    ...
                    str(anneal_seed),
                    "--curvature-bonus",
                    str(fixed_params["annealing_curvature_bonus"]),
                    "--curvature-penalty",
                    str(fixed_params["annealing_curvature_penalty"]),
                    "--curvature-tolerance",
                    str(fixed_params["annealing_curvature_tolerance"]),
                ],
                cwd=PROJECT_ROOT,
